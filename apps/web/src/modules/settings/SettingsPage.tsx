    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-12 animate-in fade-in duration-fast">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs overflow-hidden">
        ...
        <div className="p-6 bg-slate-50/50 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-slate-200 text-sm space-y-1">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Business Name</span>
              <p className="text-sm font-semibold text-slate-900">SR ENTERPRISES</p>
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200 text-sm space-y-1">
              ...
              <p className="text-sm font-semibold text-slate-900">+91 90216 53893</p>
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200 text-sm space-y-1">
              ...
              <p className="text-sm font-semibold text-slate-900">varpes380@gmail.com</p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs overflow-hidden">
        <div className="p-6 border-b border-slate-100 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-semibold text-slate-900">Financial & Payment Parameters</h2>
        ...
        <div className="p-6 bg-slate-50/50 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-lg border border-slate-200 text-sm space-y-1">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Primary Merchant VPA</span>
              <code className="block text-xs bg-slate-100 px-2 py-1.5 rounded font-mono text-slate-800 font-semibold">
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200 text-sm space-y-1">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Default Tax Structure</span>
              <p className="text-sm font-semibold text-slate-900">18.00% Standard GST</p>
        ...
        <div className="p-6 bg-slate-50/50 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div className="bg-white p-3.5 rounded-lg border border-slate-200 space-y-1">
              <span className="font-semibold text-slate-500 uppercase tracking-wider">Database Engine</span>
              <p className="font-mono font-bold text-slate-800">PostgreSQL / PGlite</p>
              <p className="text-slate-400">ACID Compliant</p>
            </div>
            <div className="bg-white p-3.5 rounded-lg border border-slate-200 space-y-1">
              <span className="font-semibold text-slate-500 uppercase tracking-wider">PDF Rendering</span>
              <p className="font-mono font-bold text-slate-800">DomPDF CLI Engine</p>
              <p className="text-slate-400">High-Resolution Vector Documents</p>
            </div>
            <div className="bg-white p-3.5 rounded-lg border border-slate-200 space-y-1">
              <span className="font-semibold text-slate-500 uppercase tracking-wider">Notification Dispatch</span>
              <p className="font-mono font-bold text-slate-800">PHPMailer (Gmail SMTP)</p>
