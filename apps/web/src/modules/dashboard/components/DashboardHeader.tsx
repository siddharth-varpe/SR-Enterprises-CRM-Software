      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight leading-tight flex items-center gap-2">
            <span>Good morning, {user?.username || 'Admin'}</span>
            <span>👋</span>
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <form onSubmit={handleSearchSubmit} className="relative min-w-[220px] sm:min-w-[280px]">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-4 bg-white rounded-xl border border-slate-200/90 text-xs sm:text-sm font-medium text-slate-900 placeholder:text-slate-400 shadow-2xs hover:border-slate-300 focus:border-[#5B3EBB] focus:ring-2 focus:ring-[#5B3EBB]/15 focus:outline-none transition-all"
            />
          </form>
          ...
          {/* Notifications Control with Unread Badge */}
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-200 z-50 p-4 animate-in fade-in slide-in-from-top-2 duration-150">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex items-start gap-2.5">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900">3 new inquiries from website</p>
                ...
                <button
                  ...
                  className="w-full mt-3 py-2 text-center text-xs font-bold text-primary-600 hover:text-primary-700 bg-primary-50/70 hover:bg-primary-50 rounded-xl transition-colors cursor-pointer"
                >
          ...
          <div className="relative">
            ...
            >
              <div className="w-7 h-7 rounded-lg bg-[#5B3EBB]/10 text-[#5B3EBB] font-bold text-xs flex items-center justify-center border border-[#5B3EBB]/20 overflow-hidden">
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border border-slate-200 z-50 p-2 animate-in fade-in slide-in-from-top-2 duration-150">
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-left text-xs font-medium text-red-600 hover:bg-red-50 rounded-lg flex items-center gap-2 mt-1"
                >
